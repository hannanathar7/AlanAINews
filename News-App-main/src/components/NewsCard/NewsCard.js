        ...
        <Card ref={elRefs[i]}className={classNames(classes.card, activeArticle===i ? classes.activeCard : null)}>
            <CardActionArea href={url} target="_blank">
                ...
                <div className={classes.details}>
                    <Typography variant="body2" color="textSecondry" component="h2">{(new Date(publishedAt)).toDateString()}</Typography>
                    <Typography variant="body2" color="textSecondry" component="h2">{source.name}</Typography>
                </div>
